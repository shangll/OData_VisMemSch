...
function instr1_loopLoopBegin(instr1_loopLoopScheduler) {
  ...
  for (const thisInstr1_loop of instr1_loop) {
...
function instr2_loopLoopBegin(instr2_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisInstr2_loop of instr2_loop) {
...
function instr3_loopLoopBegin(instr3_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisInstr3_loop of instr3_loop) {
...
function pTBR_loopLoopBegin(pTBR_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisPTBR_loop of pTBR_loop) {
...
function psPresen_loopLoopBegin(psPresen_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisPsPresen_loop of psPresen_loop) {
...
function pStudy_loopLoopBegin(pStudy_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisPStudy_loop of pStudy_loop) {
...
function ptHint_loopLoopBegin(ptHint_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisPtHint_loop of ptHint_loop) {
...
function pTest_loopLoopBegin(pTest_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisPTest_loop of pTest_loop) {
...
function endHint_loopLoopBegin(endHint_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisEndHint_loop of endHint_loop) {
...
function pSearch_loopLoopBegin(pSearch_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisPSearch_loop of pSearch_loop) {
...
function blockOrdLoopBegin(blockOrdLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisBlockOrd of blockOrd) {
...
function sub30_loopLoopBegin(sub30_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSub30_loop of sub30_loop) {
...
function stim17_loopLoopBegin(stim17_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisStim17_loop of stim17_loop) {
...
function distr_loopLoopBegin(distr_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisDistr_loop of distr_loop) {
...
function altDistrStim_loopLoopBegin(altDistrStim_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisAltDistrStim_loop of altDistrStim_loop) {
...
function chooseDistr_loopLoopBegin(chooseDistr_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisChooseDistr_loop of chooseDistr_loop) {
...
function TBR_loopLoopBegin(TBR_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisTBR_loop of TBR_loop) {
...
function study_presenLoopBegin(study_presenLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisStudy_presen of study_presen) {
...
function testHint_presenLoopBegin(testHint_presenLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisTestHint_presen of testHint_presen) {
...
function expCtrl_loopLoopBegin(expCtrl_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisExpCtrl_loop of expCtrl_loop) {
...
function sch_loopLoopBegin(sch_loopLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisSch_loop of sch_loop) {
...
function instrEG1RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrEG1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function instrEG2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrEG2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function instrSCHegRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrSCHegComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function instrHintEndRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrHintEndComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function instrInterRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrInterComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function instrSCHRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrSCHComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function instrHintExpRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrHintExpComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function instrEndRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrEndComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function pTBRctrlRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of pTBRctrlComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function jdgTestFileRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of jdgTestFileComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function pStudyHintRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of pStudyHintComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function pStudyTrialsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of pStudyTrialsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function pTestHintRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of pTestHintComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function pTestTrialsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of pTestTrialsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function pTextITIRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of pTextITIComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function pACCcountRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of pACCcountComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function endHintRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of endHintComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function pSearchHintRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of pSearchHintComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function pSearchTrialsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of pSearchTrialsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function pACCpresenRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of pACCpresenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function expStartRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of expStartComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function preExpRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of preExpComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function subCountBeginRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of subCountBeginComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function stimCountBeginRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of stimCountBeginComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function inAllStimRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of inAllStimComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function subCountPlusRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of subCountPlusComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function distrCtrlRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of distrCtrlComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function altStimCountBeginRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of altStimCountBeginComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function inAltDistrRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of inAltDistrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function distrCountBeginRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of distrCountBeginComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function inBothDistrRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of inBothDistrComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function listMergeRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of listMergeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function TBRLoopCtrlRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of TBRLoopCtrlComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function studyHintRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of studyHintComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function studyTrialsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of studyTrialsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function testHintRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of testHintComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function testTrialsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of testTrialsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function test_itiRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of test_itiComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function TBRcountPlusRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of TBRcountPlusComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function searchHintRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of searchHintComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function searchTrialsRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of searchTrialsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function schACCpresenRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of schACCpresenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
